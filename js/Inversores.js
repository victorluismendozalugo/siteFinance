...
var vue2 = new Vue({
    ...
    methods: {
        ...
        editarRegistro(item) {
            console.log(item)
            //if (item.estatus == "D") {
            //this.credito.usuarioID = item.usuarioID
            //this.credito.nombreCompleto = item.nombreCompleto
            //this.$bvModal.show('modal-nuevo-credito');
            //}
        ...
        calculaPagosNuevo() {
            this.credito.valorXpago = ((this.credito.numeroPagos * parseFloat(0.0375) * parseFloat(this.credito.montoSolicitado)) + parseFloat(this.credito.montoSolicitado)) / this.credito.numeroPagos
            this.credito.totalPagar = (this.credito.numeroPagos * this.credito.valorXpago)
            this.credito.interesOrdinario = this.credito.totalPagar - this.credito.montoSolicitado
            this.credito.valorXpago = Math.ceil(this.credito.valorXpago)
        },
    }
});
