<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Generos.aspx.cs" Inherits="WebSystems2021.Generos" %>
    ...
    <template>
      ...
      <b-modal id="modal-registro" size="lg" title="Large Modal" hide-header="true">
        <div class="form-group row">
          <div class="col-xs">
            <label>Clave genero</label>
            <input type="number" class="form-control" v-model="genero.generoID" name="Clave" readonly="true" />
          </div>
          <div class="col-sm">
            <label>Descripción </label>
            <input type="text" class="form-control" v-model="genero.generoDescripcion" name="Descripcion" maxlength="1000" />
          </div>
          <div class="col-sm">
            <label>Estatus</label>
            <b-form-select class="form-control" v-model="genero.generoEstatus" :options="optionsEstatus"></b-form-select>
          </div>
        </div>
        <template #modal-footer>
          ...
          <b-button variant="primary" class="float-right" @click="GuardarGeneros">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Listado de generos</h4>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <b-table class="table table-hover table-striped" hover :items="this.generos" :fields="fields"
                ...
                <template v-slot:table-busy>
                  <div class="text-center text-warning my-2">
                    ...
                    <strong>Cargando generos...</strong>
                  </div>
                </template>
              </b-table>
            </div>
