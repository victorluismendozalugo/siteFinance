   ...
   <div id="vuePage">
    <template>
            ...
            <div class="login-box">
                <div class="card">
                    <div class="card-body login-card-body">
                        <img  class="img-fluid" src="images/LogoLogin.jpg" />
                        <br />
                        <br />
                        <form>
                            ...
                            <div class="input-group mb-3">
                                <input type="Password" placeholder="Contraseña" class="form-control"
                                    v-model="usuarios.Password" name="password" value="" v-on:keypress="validaInicio"
                                    required="required" />
                                <div class="input-group-append">
                                    <div class="input-group-text">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <b-button type="submit" class="btn btn-primary btn-block"
                                        @click="ValidaCredenciales">Iniciar
                                    </b-button>
                                </div>
                            </div>
                        </form>
            ...
            <div class="modal fade" id="registrationModal" tabindex="-1" role="dialog"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <b-form-input type="email" class="form-control"
                                            placeholder="Ingrese su correo electrónico" v-model="registro.usuario"
                                            :class="[isEmailValidUser()]" required
                                            placeholder="Ingrese su correo electrónico"
                                            @input="v => { registro.usuario = v.toUpperCase()}"></b-form-input>
                                        <label>Validación correo</label>
                                        <b-form-input type="email" class="form-control"
                                            placeholder="Ingrese nuevamente su correo electrónico"
                                            v-model="registro.validaUsuario" :class="[isEmailValidUser2()]" required
                                            placeholder="Ingrese su correo electrónico"
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="password" class="form-control"
                                                    v-model="registro.contrasena" placeholder="Ingrese una contraseña">
                                            </div>
                                            <div class="col-6">
                                                <label>Validación Contraseña</label>
                                                <input type="password" class="form-control"
                                                    v-model="registro.validaContrasena"
                ...
                <div class="modal fade" id="solicitudCorreoModal" tabindex="-1" role="dialog"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <b-form-input type="text" class="form-control" v-model="solicitud.usuario"
                                            placeholder="Ingrese su correo electrónico"
                                            @input="v => { solicitud.usuario = v.toUpperCase()}"></b-form-input>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <b-button type="button" variant="secondary" data-dismiss="modal">Cancelar</b-button>
                                <b-button type="button" variant="primary" @click="ValidaDatosSolicitudCorreo">
                                    Solicitar
                                </b-button>
                            </div>
                        </div>
    ...
    <script src="js/Login.js?7.0.0"></script>
</body>
</html>
