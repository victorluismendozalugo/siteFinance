        ...
        <div class="container">
            <template>
                ...
                <div class="card card-info">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Datos de la inversión</h3>
                    </div>
                    <div class="card-body" v-if="usuario.tipoUsuario=='PRESTAMO'">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-8">
                                ...
                                <b-form-input type="text" class="form-control w-100" v-model="frecuenciaPagosCredito"
                                    disabled></b-form-input>
                            </div>
                    ...
                    <div class="card-body" v-if="usuario.tipoUsuario=='INVERSION'">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-8">
                                ...
                                <b-form-input type="number" class="form-control" v-model="plazo" name="Plazo en meses"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-8">
                                ...
                                <b-form-input type="text" class="form-control w-100" v-model="rendimientAnual" disabled>
                                </b-form-input>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-xs-12">
                                ...
                                <input @change="handleImage1" class="custom-input btn btn-success col fileinput-button"
                                    type="file" accept="image/*,application/pdf" style="visibility:hidden;" id="files1">
                            ...
                            <div class="col-sm-4 col-xs-12">
                                ...
                                <input @change="handleImage2" class="custom-input btn btn-success col fileinput-button"
                                    type="file" accept="image/*,application/pdf" style="visibility:hidden;" id="files2">
                            ...
                            <div class="col-sm-4 col-xs-12" v-if="usuario.tipoUsuario == 'PRESTAMO'">
                                ...
                                <input @change="handleImage3" class="custom-input btn btn-success col fileinput-button"
                                    type="file" accept="image/*,application/pdf" style="visibility:hidden;" id="files3">
