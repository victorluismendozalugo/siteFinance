<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TiposPago.aspx.cs" Inherits="WebSystems2021.TiposPago" %>
      ...
      <b-modal id="modal-registro" size="lg" title="Large Modal" hide-header="true">
        <div class="form-group row">
          <div class="col-xs">
            ...
            <input type="number" class="form-control" v-model="pago.pagoID" name="Clave" readonly="true" />
          </div>
          <div class="col-sm">
            <label>Descripción </label>
            <input type="text" class="form-control" v-model="pago.pagoNombre" name="Descripcion" maxlength="1000" />
          </div>
          <div class="col-sm">
            <label>Estatus</label>
            <b-form-select class="form-control" v-model="pago.pagoEstatus" :options="optionsEstatus"></b-form-select>
          </div>
        </div>
        <template #modal-footer>
          ...
          <b-button variant="primary" class="float-right" @click="GuardarTiposPago">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Listado de formas de pago</h4>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <b-table class="table table-hover table-striped" hover :items="this.pagos" :fields="fields"
...
<script src="js/TiposPago.js"></script>
</asp:Content>