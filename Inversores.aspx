               ...
               <div class="card card-info">
                ...
                <div class="card-body">
                    <div class="row">
                          <div class="col-sm-4 col-xs-8">
                           <label>Monto solicitado</label>
                          <b-form-select class="form-control" v-model="credito.montoSolicitado" :options="optionsMontoSolicitado" @change="calculaPagosNuevo">
                        </b-form-select>
                        </div>

                         <div class="col-sm-4 col-xs-8">
                           <label>Interés ordinario</label>
                       <input type="number" class="form-control" v-model="credito.interesOrdinario" name="Interés ordinario"
                              readonly />
                        </div>

                          <div class="col-sm-4 col-xs-8">
                           <label>Total a pagar</label>
                       <input type="number" class="form-control" v-model="credito.totalPagar" name="Total a pagar"
                              readonly />
                        </div>
                     ...
                     <div class="row">
                        ...
                        <b-form-select class="form-control" v-model="credito.numeroPagos" :options="optionsNumeroPagos" @change="calculaPagosNuevo">
                         ...
                         <div class="col-sm-4 col-xs-8">
                          ...
                          <div class="col-sm-4 col-xs-8">
                           <label>Valor de cada pago</label>
                       <input type="number" class="form-control" v-model="credito.valorXpago" name="Valor de cada pago"
                              readonly />
                        </div>
                ...
                <br />
                <div class="modal-footer">
                    <b-button type="button" variant="warning" @click="DardeAlta()">Reactivar crédito
                    </b-button>
                </div>
            </b-modal>
